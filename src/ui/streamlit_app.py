...
def build_config_overview() -> pd.DataFrame:
    rows = [
        ...
        {"key": "DEFAULT_LLM_MODEL", "value": str(getattr(settings, "DEFAULT_LLM_MODEL", ""))},
        {"key": "LLM_MODEL", "value": str(getattr(settings, "LLM_MODEL", ""))},
        {"key": "REPORT_AGENT_MODEL", "value": str(getattr(settings, "REPORT_AGENT_MODEL", ""))},
        {"key": "RISK_REVIEW_AGENT_MODEL", "value": str(getattr(settings, "RISK_REVIEW_AGENT_MODEL", ""))},
        {"key": "STRATEGY_RESEARCH_AGENT_MODEL", "value": str(getattr(settings, "STRATEGY_RESEARCH_AGENT_MODEL", ""))},
        {"key": "PARAMETER_ITERATION_AGENT_MODEL", "value": str(getattr(settings, "PARAMETER_ITERATION_AGENT_MODEL", ""))},
